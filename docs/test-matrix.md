...
Attempt unsigned, altered, replayed, vulnerable, wrong-issuer, tag-swapped, and exception images; test keyless verification outage, break-glass expiry, audit mode, policy rollout, and evidence retention.
